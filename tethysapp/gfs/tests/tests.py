    ...
    4. Enter tethys test command.
       ...
       See below for specific examples
        ...
        To run all tests across this app:
            Test command: "tethys test -f tethys_apps.tethysapp.gfs"

        To run all tests in this file:
            Test command: "tethys test -f tethys_apps.tethysapp.gfs.tests.tests"

        To run tests in the GfsTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.gfs.tests.tests.GfsTestCase"

        To run only the test_if_tethys_platform_is_great function in the GfsTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.gfs.tests.tests.GfsTestCase.test_if_tethys_platform_is_great"
...
class GfsTestCase(TethysTestCase):
    """
    ...
    def set_up(self):
        ...
        test database creation function here, like so:
            ...
            self.create_test_persistent_stores_for_app(Gfs)
    ...
    def tear_down(self):
        ...
        stores, you should call the test database destruction function from here, like so:
            ...
            self.destroy_test_persistent_stores_for_app(Gfs)
    ...
    def test_home_controller(self):
        ...
        response = c.get('/apps/gfs/')  # The final '/' is essential for all pages/controllers
