...
def gfs_variables():
    return [
        ...
        ('Latent heat net flux', 'lhtfl'), ('Land-sea mask', 'lsm'), ('Maximum/Composite radar reflectivity', 'refc'),
        ('Maximum temperature', 'tmax'), ('Minimum temperature', 'tmin'), ('Momentum flux, u component', 'uflx'),
        ('Momentum flux, v component', 'vflx'), ('Meridional flux of gravity wave stress', 'v-gwd'),
        ('MSLP (Eta model reduction)', 'mslet'), ('Orography', 'orog'), ('Ozone mixing ratio', 'o3mr'),
        ('Total ozone', 'tozne'), ('Pressure', 'pres'), ('Pressure of level from which parcel was lifted', 'plpl'),
        ('Potential temperature', 'pt'), ('Potential evaporation rate', 'pevpr'), ('Precipitation rate', 'prate'),
        ...
        ('Soil Temperature', 'st'),
        ('Volumetric soil moisture content', 'soilw'), ('2 metre temperature', '2t'), ('Specific humidity', 'q'),
        ('2 metre dewpoint temperature', '2d'), ('2 metre relative humidity', '2r'),
        ('10 metre U wind component', '10u'), ('10 metre V wind component', '10v'), ('U component of wind', 'u'),
        ('V component of wind', 'v'), ('Temperature', 't'), ('100 metre U wind component', '100u'),
        ('100 metre V wind component', '100v'), ('Storm relative helicity', 'hlcy'),
        ('U-component storm motion', 'ustm'), ('V-component storm motion', 'vstm'),
        ('Ice water mixing ratio', 'icmr'), ('Snow mixing ratio', 'snmr'),
        ('Vertical velocity', 'w'), ('Icing severity', 'ICSEV'), ('5-wave geopotential height', '5wavh'),
        ('ICAO Standard Atmosphere reference height', 'icaht'),
        ('Upward short-wave radiation flux', 'uswrf'),
        ('Upward long-wave radiation flux', 'ulwrf'), ('Vertical speed shear', 'vwsh'),
        ('Visibility', 'vis'), ('Wind speed (gust)', 'gust'), ('Surface pressure', 'sp'),
        ('Water equivalent of accumulated snow depth', 'sdwe'), ('Snow depth', 'sde'),
        ('Total Precipitation', 'tp'), ('Water runoff', 'watr'), ('Sensible heat net flux', 'shtfl'),
        ('Wilting Point', 'wilt'),  ('Sunshine Duration', 'SUNSD'),
        ('Surface lifted index', 'lftx'),
        ('Sea ice area fraction', 'ci'),
        ('Ventilation Rate', 'VRATE'), ('Zonal flux of gravity wave stress', 'u-gwd'),
    ]
